defmodule Issues.TableFormatter do
  ...
  @doc """
  Takes a list fo row data,  where each row is a HashDict, and a list of
  ...
  each column. The `headers` paramter contains the
  ...
  ## Examples
      ...
      "a"
      iex> Issues.TableFormatter.printable(00)
      "99"
  """
  ...
  @doc """
  Returns a format string that hard codes the widths of a set of columns.
  ...
  hyphens, with + signswhere the vertical bar between the columns goes.
